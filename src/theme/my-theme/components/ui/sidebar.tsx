  ...
  (
    ...
    if (isMobile) {
      return (
        <div
          className={cn(
            'fixed inset-y-0 z-50 h-svh w-[--sidebar-width] translate-x-0 border-r border-sidebar-border bg-sidebar text-sidebar-foreground transition-transform duration-300',
    ...
    return (
      ...
      >
        ...
        >
          <div
            className={cn(
              'flex h-full w-[--sidebar-width] flex-col bg-sidebar border-r border-sidebar-border',
              'group-data-[collapsible=icon]:w-[--sidebar-width-icon]',
